...
<div id="content">
  <?php
    $hidcatslide = get_theme_mod('jewellery_shop_hide_categorysec', '1');
    if( $hidcatslide == ''){
  ?>
    <section id="catsliderarea">
      <div class="catwrapslider">
        <div class="owl-carousel">
          ...
          <?php $queryvar = new WP_Query('cat='.esc_attr(get_theme_mod('jewellery_shop_slidersection',true)));
  ...
  <?php
    $jewellery_shop_hidepageboxes = get_theme_mod('jewellery_shop_disabled_pgboxes', '1');
